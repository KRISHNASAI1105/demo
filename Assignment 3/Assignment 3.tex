...
\newline By\  Binomial\  distribution,
\newline
\begin{equation}
Pr(X = k) &= \binom{n}{k}(P)^k(1-P)^{n-k} 
\end{equation}
\begin{equation}
Pr(X = 0) &= \binom{50}{0}(\dfrac{1}{50})^0(1 - \dfrac{1}{50})^{50-0} 
\end{equation}
\begin{equation}
\implies Pr(X = 0) &= (\dfrac{49}{50})^{50}
\end{equation}
\begin{equation}
Pr(X = 1) &= \binom{50}{1}(\dfrac{1}{50})^1(1 - \dfrac{1}{50})^{50-1}
\end{equation}
\begin{equation}
 \implies Pr(X = 1) &= (\dfrac{49}{50})^{49}
\end{equation}

\item \Pr{(X \ge 2)} = 1 - \Pr{(X < 2)} \\
\implies \Pr{(X \ge 2)} = 1 - [{\Pr{(X = 0)} + \Pr{(X = 1)}}] \\
\implies \Pr{(X \ge 2)} = 1 - [{(\dfrac{49}{50})^{50}} + {(\dfrac{49}{50})^{49}}] \\
\implies \Pr{(X \ge 2)} = 1 - [{(\dfrac{49}{50})^{49}}][{\dfrac{49}{50}} + {1}] \\
\implies \Pr{(X \ge 2)} = 1 - [{(\dfrac{49}{50})^{49}}][{\dfrac{99}{50}}] \\
