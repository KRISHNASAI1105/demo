...
\includegraphics[width=0.9\linewidth, height=6cm]{Screenshot (172).png} 
\caption{Where not to use PCA.}
\label{fig:subim1}
\end{subfigure}\;
\begin{subfigure}{0.75\textwidth}
\includegraphics[width=0.9\linewidth, height=6cm]{Screenshot (173).png}
...
\end{figure}
    \begin{figure}[!htb]
\begin{subfigure}{0.75\textwidth}
\includegraphics[width=0.9\linewidth, height=6cm]{Screenshot (174).png} 
\caption{Uses of PCA.}
\label{fig:subim1}
\end{subfigure}\;
\begin{subfigure}{0.75\textwidth}
\includegraphics[width=0.9\linewidth, height=6cm]{Screenshot (175).png}
