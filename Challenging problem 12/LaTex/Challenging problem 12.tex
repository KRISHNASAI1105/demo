...
\begin{center}
    ...
    $\lambda_2$ = 1 \\
    $\lambda_3$ = \dfrac{1}{3} \\
    $\lambda_4$ = \dfrac{1-\sqrt{2}}{3} \\
    $\lambda_5$ = \dfrac{1+\sqrt{2}}{3} \\
\end{center} \\
Corresponding Eigenvectors are: \\
Eigenvector $V_1$ for \lambda_1=1 :\\
\begin{math}
\left[
\begin{array}{c}
     1\\
...
\end{array}\right]
\end{math} \\
Eigenvector $V_2$ for \lambda_2=1 :\\
\begin{math}
\left[
\begin{array}{c}
      0\\
...
\end{array}\right]
\end{math} \\
Eigenvector $V_3$ for \lambda_3=\dfrac{1}{3} :\\
\begin{math}
\left[
\begin{array}{c}
      -1\\
...
\end{array}\right]
\end{math} \\
Eigenvector $V_4$ for $\lambda_4$=\dfrac{1-\sqrt{2}}{3} :\\
\begin{math}
\left[
\begin{array}{c}
      1\\
...
\end{array}\right]
\end{math} \\
Eigenvector $V_5$ for $\lambda_5$=\dfrac{1+\sqrt{2}}{3} :\\
\begin{math}
\left[
\begin{array}{c}
      1\\
