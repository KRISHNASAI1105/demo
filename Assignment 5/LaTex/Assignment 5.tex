...
\begin{figure}[!htb]
\centering
\includegraphics[width = 0.45\textwidth]{CDF of X.png}
\end{figure}
...
The PDF of $X$ is,
\begin{align*}
             f_Z(x) &= \int\limits_{-\infty}^\infty f(x)d x \\
    Pr{(Z>2 | Z>1)} &= \dfrac{Pr{((Z>2)\cap (Z>1))}}{Pr{(Z>1)}} \\
                    &= \dfrac{Pr{(Z>2)}}{Pr{(Z>1)}} \\
                    &= \dfrac{\int\limits_{2}^\infty {e^{-x}}d x}{\int\limits_{1}^\infty {e^{-x}}d x} \\
                    &= \dfrac{-({e^{-\infty}} - {e^{-2}})}{-({e^{-\infty}} - {e^{-1}})} \\
                    &= \dfrac{e^{-2}}{e^{-1}} \\
                    &= e^{-1} \\
                    &= 0.3679
\end{align*}
...
\begin{figure}[!htb]
\centering
\includegraphics[width = 0.45\textwidth]{Probability.png}
\end{figure}
