...
\pr{X_4>Max(X_1,X_2)>X_3} 
\begin{align}
&= \int\limits_{-\infty}^\infty f_X(x) \int\limits_{-\infty}^x f_X(t).\comb{2}{1}. \nonumber\sbrak{\int\limits_{-\infty}^t f_X(w) d w} 
...
\begin{align}
&= \int\limits_{-\infty}^\infty f_X(x) \int\limits_{-\infty}^x f_X(t) 
\int\limits_{-\infty}^t f_X(z). \comb{2}{1} \sbrak{\int\limits_{-\infty}^t f_X(w) d w}\ d z d t d x \\
